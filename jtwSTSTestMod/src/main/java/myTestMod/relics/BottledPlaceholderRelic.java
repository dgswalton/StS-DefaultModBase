...
import myTestMod.patches.relics.BottledPlaceholderField;
import myTestMod.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static myTestMod.DefaultMod.makeRelicOutlinePath;
import static myTestMod.DefaultMod.makeRelicPath;
