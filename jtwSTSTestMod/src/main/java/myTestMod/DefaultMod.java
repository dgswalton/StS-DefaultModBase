...
import myTestMod.cards.*;
import myTestMod.characters.TheDefault;
import myTestMod.events.IdentityCrisisEvent;
import myTestMod.potions.PlaceholderPotion;
import myTestMod.relics.BottledPlaceholderRelic;
import myTestMod.relics.DefaultClickableRelic;
import myTestMod.relics.PlaceholderRelic;
import myTestMod.relics.PlaceholderRelic2;
import myTestMod.util.IDCheckDontTouchPls;
import myTestMod.util.TextureLoader;
import myTestMod.variables.DefaultCustomVariable;
import myTestMod.variables.DefaultSecondMagicNumber;
...
public class DefaultMod implements
    ...
    public static Properties myTestModDefaultSettings = new Properties();
    ...
    private static final String ATTACK_DEFAULT_GRAY = "myTestModResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "myTestModResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "myTestModResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "myTestModResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "myTestModResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "myTestModResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "myTestModResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "myTestModResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "myTestModResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "myTestModResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "myTestModResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "myTestModResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "myTestModResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "myTestModResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "myTestModResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "myTestModResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "myTestModResources/images/char/defaultCharacter/skeleton.json";
    ...
    public DefaultMod() {
      ...
      */
        ...
        // 1. Go to your resources folder in the project panel, and refactor> rename myTestModResources to
        // yourModIDResources.
        ...
        myTestModDefaultSettings.setProperty(ENABLE_PLACEHOLDER_SETTINGS, "FALSE"); // This is the default setting. It's actually set...
        try {
            SpireConfig config = new SpireConfig("defaultMod", "myTestModConfig", myTestModDefaultSettings); // ...right here
    ...
    public void receivePostInitialize() {
        ...
        ModLabeledToggleButton enableNormalsButton = new ModLabeledToggleButton("This is the text which goes next to the checkbox.",
            ...
            try {
                ...
                SpireConfig config = new SpireConfig("defaultMod", "myTestModConfig", myTestModDefaultSettings);
